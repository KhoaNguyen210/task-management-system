                ...
                <div>
                    ...
                    @endif
                     @if(Auth::user()->role === 'Department Head' && Auth::user()->department_id === $task->department_id)
                         <div class="flex space-x-2 mt-4">
                            {{-- Thêm nút Đánh giá, Sửa, Xóa cho Trưởng BM nếu cần --}}
                            <a href="#" class="bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-600 transition duration-200 text-sm">Đánh giá</a>
